...
Para el analisis de los datos recolectados, se procedio a escoger el paquete de R, llamado "Rmark", es un modelo que se utiliza para animales no marcados y que se adapta a distintos caracteristicas, donde uno de ellos es el planteado en esta investigación.

Asi mismo, se utilizo un modelo en relación a la tematica de remoción que se encuentra dentro del paquete "Rmark" y es titulado como "gmultmix Generalized multinomial N-mixture model", el cual toma encuenta las caracteristicas de  abundancia, disponibilidad y probabilidad de detección. 

Los argumentos principales son los siguientes:
    n= Numero de sitios
    T= Numero periodo primario 
    J= Numero periodo secundario
lam= 3;phi= 0.5; p= 0.3: Son formulas ya establecidas para describir las covariables de detección.
 ...
 Por otra parte las ecuaciones que se utilizaran son las siguientes:
  ...
  Donde M: representa tamaño de la polación local y N: disponibilidad de los individuos detectados.
